...
한 곳에만 있다 — 강사구성 40(`staffScore/5×40`) · 강사료 20/14/6 · 연수 10/5 · 간식 8/4/2 ·
종합판정 15/8/0 · 하트 +7. 안 채운 항목은 0점, 아예 미평가면 `null`(랭킹 맨 아래),
**강사구성 0이면 무조건 0점**. 리스트는 종합점수·강사구성·가나다·평가완료 우선으로 정렬할 수 있다.
